...
const gameConsts : any = {
  ...
  gameConsts.BODYPARTS_ALL = [
    gameConsts.MOVE,
    gameConsts.WORK,
    gameConsts.CARRY,
    gameConsts.ATTACK,
    gameConsts.RANGED_ATTACK,
    gameConsts.TOUGH,
    gameConsts.HEAL,
    gameConsts.CLAIM,
  ];

  gameConsts.RESOURCES_ALL= [
    gameConsts.RESOURCE_ENERGY,
    gameConsts.RESOURCE_POWER,
    gameConsts.RESOURCE_HYDROGEN,
    gameConsts.RESOURCE_OXYGEN,
    gameConsts.RESOURCE_UTRIUM,
    gameConsts.RESOURCE_KEANIUM,
    gameConsts.RESOURCE_LEMERGIUM,
    gameConsts.RESOURCE_ZYNTHIUM,
    gameConsts.RESOURCE_CATALYST,
    gameConsts.RESOURCE_GHODIUM,
    gameConsts.RESOURCE_HYDROXIDE,
    gameConsts.RESOURCE_ZYNTHIUM_KEANITE,
    gameConsts.RESOURCE_UTRIUM_LEMERGITE,
    gameConsts.RESOURCE_UTRIUM_HYDRIDE,
    gameConsts.RESOURCE_UTRIUM_OXIDE,
    gameConsts.RESOURCE_KEANIUM_HYDRIDE,
    gameConsts.RESOURCE_KEANIUM_OXIDE,
    gameConsts.RESOURCE_LEMERGIUM_HYDRIDE,
    gameConsts.RESOURCE_LEMERGIUM_OXIDE,
    gameConsts.RESOURCE_ZYNTHIUM_HYDRIDE,
    gameConsts.RESOURCE_ZYNTHIUM_OXIDE,
    gameConsts.RESOURCE_GHODIUM_HYDRIDE,
    gameConsts.RESOURCE_GHODIUM_OXIDE,
    gameConsts.RESOURCE_UTRIUM_ACID,
    gameConsts.RESOURCE_UTRIUM_ALKALIDE,
    gameConsts.RESOURCE_KEANIUM_ACID,
    gameConsts.RESOURCE_KEANIUM_ALKALIDE,
    gameConsts.RESOURCE_LEMERGIUM_ACID,
    gameConsts.RESOURCE_LEMERGIUM_ALKALIDE,
    gameConsts.RESOURCE_ZYNTHIUM_ACID,
    gameConsts.RESOURCE_ZYNTHIUM_ALKALIDE,
    gameConsts.RESOURCE_GHODIUM_ACID,
    gameConsts.RESOURCE_GHODIUM_ALKALIDE,
    gameConsts.RESOURCE_CATALYZED_UTRIUM_ACID,
    gameConsts.RESOURCE_CATALYZED_UTRIUM_ALKALIDE,
    gameConsts.RESOURCE_CATALYZED_KEANIUM_ACID,
    gameConsts.RESOURCE_CATALYZED_KEANIUM_ALKALIDE,
    gameConsts.RESOURCE_CATALYZED_LEMERGIUM_ACID,
    gameConsts.RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE,
    gameConsts.RESOURCE_CATALYZED_ZYNTHIUM_ACID,
    gameConsts.RESOURCE_CATALYZED_ZYNTHIUM_ALKALIDE,
    gameConsts.RESOURCE_CATALYZED_GHODIUM_ACID,
    gameConsts.RESOURCE_CATALYZED_GHODIUM_ALKALIDE,
  ];

  gameConsts.COLORS_ALL = [
    gameConsts.COLOR_RED,
    gameConsts.COLOR_PURPLE,
    gameConsts.COLOR_BLUE,
    gameConsts.COLOR_CYAN,
    gameConsts.COLOR_GREEN,
    gameConsts.COLOR_YELLOW,
    gameConsts.COLOR_ORANGE,
    gameConsts.COLOR_BROWN,
    gameConsts.COLOR_GREY,
    gameConsts.COLOR_WHITE,
  ];
