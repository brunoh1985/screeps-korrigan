...
interface CreepTaskMemory {
  taskType: string;
  taskTargetId?: string;
  taskTargetRoom?: string;
  taskStateType?: string;
  taskStateTargetId?: string;
  taskStateTargetRoom?: string;
}

interface CreepMemory extends CreepTaskMemory {
  room: string;
  role: string;
}
...
// -------------------  override Creep interface declaration -------------//

interface HaveMemory {
    /**
...
interface CreepProps extends RoomObject {
  readonly prototype: CreepProps;
  /**
 ...
 */
interface Creep extends CreepProps, CreepAction, HaveMemory {}
